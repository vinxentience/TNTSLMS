...
Public Class generate_booklist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TNTSLMS.generate_booklist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgenerate_booklist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As generate_booklist = New generate_booklist()
        rpt.Site = Me.Site
        Return rpt
    End Function
